...
export const Route = createFileRoute("/esthetische-tandheelkunde")({
  head: () => ({
    meta: [
      { title: "Esthetische Tandheelkunde Rotterdam | MondVita" },
      { name: "description", content: "Voor een stralende en natuurlijk ogende glimlach. Professioneel tanden bleken, facings en esthetische vullingen in Rotterdam bij MondVita." },
      { property: "og:title", content: "Esthetische Tandheelkunde Rotterdam | MondVita" },
    ],
    links: [{ rel: "canonical", href: "/esthetische-tandheelkunde" }],
  }),
  component: Page,
});
