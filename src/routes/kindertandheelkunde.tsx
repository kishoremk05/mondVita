...
export const Route = createFileRoute("/kindertandheelkunde")({
  head: () => ({
    meta: [
      { title: "Kindertandheelkunde Rotterdam | MondVita" },
      { name: "description", content: "Vriendelijke en geduldige kindertandheelkunde in Rotterdam bij MondVita. Samen zorgen we voor een stralende lach en een angstvrij tandartsbezoek." },
      { property: "og:title", content: "Kindertandheelkunde Rotterdam | MondVita" },
    ],
    links: [{ rel: "canonical", href: "/kindertandheelkunde" }],
  }),
  component: Page,
});
...
function Page() {
  ...
  const items = [
    ...
    { t: c("kinderCare.p2_t"), d: c("kinderCare.p2_d"), Icon: Shield, img: dynExplain },
    { t: c("kinderCare.p3_t"), d: c("kinderCare.p3_d"), Icon: Sparkles, img: dynSetup },
    { t: c("kinderCare.p4_t"), d: c("kinderCare.p4_d"), Icon: Smile, img: dynAdultMatch },
  ];
    ...
    <SiteShell>
      ...
      <section className="bg-secondary/40 py-20">
        <div className="mx-auto grid max-w-7xl gap-8 px-6 md:grid-cols-[1.8fr_1fr] md:items-start">
          {/* Left Column: Friendly child dental sections with matching illustrations */}
